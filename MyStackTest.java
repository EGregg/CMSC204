...
/**
 * THIS IS NOW WORKING DO NOT TOUCH!!!
 */
...
public class MyStackTest {
	...
	public Double ack = 1.0, bat = 2.0, cat = 3.0, delta = 4.0, ecko = 5.0, gamma = 6.0;
	...
	public void testPopStudent() {
		...
		try {
			assertEquals(cat, doubleS.pop());
			assertEquals(bat, doubleS.pop());
			assertEquals(ack, doubleS.pop());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
	...
	public void testPushStudent() {
		...
		try {
			...
			//Queue is ALMOST full, next statement should cause QueueOverFlowException
			doubleS.push(6.0);
			doubleS.push(7.0);
			assertTrue("This should have caused an StackOverflowException", false);
		}
