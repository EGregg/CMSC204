...
public interface CourseDBManagerInterface {
   ...
   */
  void add(String id, int crn, int credits, String roomNum, String instructor) ;
   ...
   */
  void readFile(File input) throws FileNotFoundException ;
